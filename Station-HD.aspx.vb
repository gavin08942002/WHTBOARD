...
Partial Class Station
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        LabelHD.Text = String.Format("<iframe id=""iframeHD"" src=""https://tpexm.mmh.org.tw/webhdboard1058/HDWebForm.aspx?Hospcode={0}"" height=""900"" width=""750""  style=""border: 0px;padding:0px; ""  ></iframe>  ", HospCode )
