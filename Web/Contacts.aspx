<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Contacts.aspx.vb" Inherits="Web_Default" %>
...
<body style ="color: rgb(102,102,102); background-color: rgb(242,242,242)" >
    ...
    <div id ="Body">
        ...
        <div id ="main">
            <!--網頁標題-->
            <div id ="topic"><span class ="big-red">連絡資訊</span></div>
            <hr />
            <!--資料內容-->
            <div id ="content">
                                    <!--值班醫師資料-->
                <div  id="statistic" >
                    <div >
                        <div class ="class_statistic_1 big" >總值班醫師</div>
                        <div class ="class_statistic_2 big " style ="background-color: rgb(79, 129, 189); color:white;" >
                            <table style="width: 100%;">
                                <tr style ="height:80px"><td>李咪麗/7654<br></td></tr>
                            </table>
                        </div>
                    </div>
                    <div >
                        <div class ="class_statistic_1 big" >值班醫師</div>
                        <div class ="class_statistic_2 big " style ="background-color: rgb(79, 129, 189);color:white; " >
                            <table style="width: 100%;">
                                <tr style ="height:80px"><td>李咪麗/7654<br>test</td></tr>
                            </table>
                        </div>
                    </div>
                    <div >
                        <div class ="class_statistic_1 big" >專科護理師</div>
                        <div class ="class_statistic_2 big "  style ="background-color: rgb(155, 187, 89);color:white;">
                                <table style="width: 100%;">
                                <tr style ="height:80px"><td>李咪麗/7654<br>test</td></tr>
                            </table>
                        </div>
