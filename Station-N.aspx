<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Station-N.aspx.vb" Inherits="Station" validateRequest="False"%>
...
<meta name="viewport" content="width=device-width, initial-scale=1"/>
    ...
    <script language="JavaScript">
        ...
        setTimeout('myrefresh()', 605000); //指定10分鐘刷新一次
    </script>
                ...
                <div id="doctor1" style="float:left; width:375px; height:900px;">
                    <div style="vertical-align: bottom; text-align: center; height:60px; color: #000;"><!--主治醫師表格抬頭-->
                    	<div class="Doctor_title" >
                            <asp:Label ID="DTitleLabel1" runat="server" Text="科別"></asp:Label></div>
                    	<div class="Doctor_title"  >
...
<!--
    ...
    -->
                ...
                <div id="doctor2" style="float:left; width:375px; height:900px;">
                    <div style="vertical-align: bottom; text-align: center; height:60px; color: #000;"><!--主治醫師表格抬頭-->
                    	<div class="Doctor_title" >
                            <asp:Label ID="DTitleLabel5" runat="server" Text="科別"></asp:Label></div>
                    	<div class="Doctor_title"   >
