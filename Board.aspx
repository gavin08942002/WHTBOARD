<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Board.aspx.vb" Inherits="_Default" %>
         ...
         <div id="Footer">
             <div id="Sub">
                <div class="btn-group btn-group-justified"> 
                        ...
                        <div class="btn-group">
                              <asp:LinkButton ID="Button7" runat="server" Text="佈告欄" PostBackUrl="Board.aspx" class="btn btn-default myButton myButton_focus"/>
                        </div>
