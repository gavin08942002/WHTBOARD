<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Doctor.aspx.vb" Inherits="_Default" %>
...
.table_content1 {/*主治醫師資料欄*/
    height:72px; 
    width:200px;
    font-size:36px;
    background-color:#FFDEAD
}
.table_content2 {/*住院醫師資料欄*/
    height:72px; 
    width:200px;
    font-size:36px;
    background-color:#AAFFEE
}
.table_content3 {/*病房資料欄*/
    height:72px; 
    width:1152px;
    font-size:36px;
                 ...
                 <div id="Main_content">
                          ...
                          <table style="width: 100%;margin-bottom:0px;" class="table table-bordered"><!--抬頭-->
                              <tr style="height:70px;" >
                                  <td class="table-title1 table-radius-top-left">主治醫師</td>
                                  <td class="table-title1">住院醫師</td>
                                  <td class="table-title1">住院醫師</td>
                                  <td class="table-title2 table-radius-top-right">病床</td>
                              </tr>
                              
                          </table>
                          <div style="width:1790px;height:650px; overflow-y:scroll;word-break:break-all;"><!--資料內容-->
                          <table style="width: 100%;" class="table table-bordered">
                              
                              <tr>
                                  <td class="table_content1">汪海洋</td>
                                  <td class="table_content2">汪海洋</td>
                                  <td class="table_content2">汪海洋</td>
                                  <td class="table_content3">1252
                                      <div class="ward-button">21A</div>
                                  </td>
                              </tr>
                              <tr>
                                  <td class="table_content1">汪海洋</td>
                          ...
                          <div style="width:1790px; height:80px"></div>
         ...
         <div id="Footer">
             <div id="Sub">
                <div class="btn-group btn-group-justified"> 
                        ...
                        <div class="btn-group">
                              <asp:LinkButton ID="Button6" runat="server" Text="醫師資訊" PostBackUrl="~/Doctor.aspx" class="btn btn-default myButton myButton_focus"/>
                        </div>
                        <div class="btn-group">
